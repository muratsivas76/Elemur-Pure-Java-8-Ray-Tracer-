...
final public class SilverTest extends Object {
  ...
  private static void generateSaveRenderedImage(String[] args) throws IOException {
    ...
    System.out.println("Usage: java -cp bin\\elenaRT.jar SilverTest [recursionDepth 1-5]");
    ...
    final Color backgroundColor = new Color(35, 35, 40);
    ...
    camera.setCameraPosition(new Point3(0, 0, 5.0));
    ...
    Material floorMaterial = new CheckerboardMaterial(
      // Colors (suitable for silver reflections)
      new Color(35, 35, 40),     // Cool dark gray (blue undertone)
      new Color(90, 95, 30),      // Cool medium gray (ideal for silver reflections)
      
      // Scale and light settings
      2.35,                       // Tighter squares (better shows silver reflections)
      0.15,                       // Ambient (to balance silver's cool tones)
      0.3,                        // Diffuse (silver reflects more, should be less diffuse)
      
      // Reflection optimizations
      0.2,                        // Higher specular (silver is more reflective)
      6.0,                        // Higher shininess (sharp reflection)
      new Color(220, 230, 240),   // Ice blue specular color (perfect with silver)
      
      // PBR properties
      0.0,                        // High reflectivity (silver is highly reflective)
      0.18,                       // Metallic IOR value
    ...
    Material material2 = new SilverPBRMaterial(0.5); // Ex: 0.1 clear like mirror
    
    Sphere sphere = new Sphere(1.0);
    Matrix4 m2 = new Matrix4();
    m2 = m2.multiply(m.rotateZ(20));
    sphere.setTransform(m2);
    
    //sphere.setMaterial(material2);
    sphere.setMaterial (new AnodizedMetalMaterial (Color.RED));
    ...
    String filename = String.format(
      "..%simages%ssilver_render_%s_depth%d.png",
