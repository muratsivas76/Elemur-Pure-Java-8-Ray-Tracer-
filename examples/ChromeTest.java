...
final public class ChromeTest extends Object {
  ...
  private static void generateSaveRenderedImage(String[] args) throws IOException {
    ...
    System.out.println("Usage: java -cp bin\\elenaRT.jar ChromeTest [recursionDepth 1-5]");
    ...
    Material material2 = new ChromePBRMaterial();
    ...
    String filename = String.format(
      "..%simages%schrome_render_%s_depth%d.png",
