...
final public class CeramicTest extends Object {
  ...
  private static void generateSaveRenderedImage(String[] args) throws IOException {
    ...
    System.out.println("Usage: java -cp bin\\elenaRT.jar CeramicTest [recursionDepth 1-5]");
    ...
    // Parlak metaller için:
    scene.addLight(new MuratPointLight(
        new Point3(2, 5, 3),
        new Color(255, 240, 220), // Sıcak beyaz ışık
        1.5
    ));
    ...
    scene.addLight(new ElenaDirectionalLight(
        ...
        new Color(255, 230, 210), // Yumuşak ışık
        0.7
    ));
    ...
    Material material = new CeramicTilePBRMaterial(
      new Color(250, 250, 255), // Buz beyazı
      new Color(60, 70, 80),    // Graphite derz
      0.5,                      // Orta boyut
      0.02,                     // İnce derz
      0.01,                     // Süper parlak
      0.5                       // Mat derz
    ...
    Material material2 = new CeramicTilePBRMaterial(
      new Color(200, 230, 255), // Açık mavi
      new Color(40, 50, 60),
      0.4,
      0.03,
      0.1,
    ...
    Sphere sphere = new Sphere(1.75);
    Matrix4 m2=new Matrix4 ();
    m2=m2.translate(new Vector3(0, 1.9, 0));
    ...
    String filename = String.format(
      "..%simages%sceramic_render_%s_depth%d.png",
