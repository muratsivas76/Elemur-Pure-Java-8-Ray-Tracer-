...
final public class WaterTest extends Object {
  ...
  private static void generateSaveRenderedImage(String[] args) throws IOException {
    ...
    System.out.println("Usage: java -cp bin\\elenaRT.jar WaterTest [recursionDepth 1-5]");
    ...
    Material floorMaterial = new CheckerboardMaterial(
      ...
      new Color(80, 80, 80),    // Medium gray (accentuates gold color)
      
      // Scale and light settings
      0.4,                      // Larger squares (suitable for gold size)
      1.25,                     // Ambient (for dark areas)
      0.5,                      // Diffuse (color saturation)
      
      // Reflection optimizations
      0.4,                      // Specular coefficient (soft reflection)
      15.0,                     // Shininess (slightly scattered reflection)
      new Color(255, 230, 180), // Warm specular color (compatible with gold)
    ...
    Material material2 = new WaterPBRMaterial();
    ...
    String filename = String.format(
      "..%simages%swater_render_%s_depth%d.png",
